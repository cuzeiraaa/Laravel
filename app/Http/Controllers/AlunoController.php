...
class AlunoController extends Controller
{
    ...
    public function add(Request $data) 
    {
        $validador = Validator::make(
            $data->all(),
            [
                'nome' => 'required|min:3|max:255' // Corrigido o max::255 antigo
            ],
            [
                'nome.required' => 'O nome é obrigatório.',
                'nome.min' => 'O campo nome deve conter no mínimo 3 caracteres.', // Corrigido texto invertido
                'nome.max' => 'O campo nome deve conter no máximo 255 caracteres.', // Corrigido texto invertido
            ]
        );
